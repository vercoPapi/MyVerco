...
local function StartHub()
    ...
    -- Ukuran Rasio 16:9 (Contoh: Lebar 320, Tinggi 180)
            ...
            for _, obj in pairs(workspace:GetDescendants()) do
                if obj:FindFirstChild("Humanoid") and obj:FindFirstChild("HumanoidRootPart") and obj ~= LocalPlayer.Character then
                    ...
                    if onScreen then
                        ...
                        -- Update Line Position (Dari tengah atas layar ke target)
                        ...
                        if lineObj then
                            ...
                            lineObj.Size = UDim2.new(0, 2, 0, dist)
                        ...
                        if VERCO_GUI:FindFirstChild(obj.Name .. "_Line") then
                            VERCO_GUI:FindFirstChild(obj.Name .. "_Line").Visible = false
                        end
                    end
                end
            end
    ...
    -- FITUR LAINNYA TETAP SAMA (DARI KODE SEBELUMNYA)
    ...
    task.delay(600, function() VERCO_GUI:Destroy() getgenv().VERCO_LOADED = false end)
end
