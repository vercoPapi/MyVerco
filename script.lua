...
local function StartMainScript()
    ...
    RunService.RenderStepped:Connect(function()
        ...
        for _, v in pairs(game.Players:GetPlayers()) do
            if v ~= Player and v.Character and v.Character:FindFirstChild("HumanoidRootPart") and v.Character.Humanoid.Health > 0 then
                ...
                -- MS20 PULL (NARIK MUSUH KE DEPAN)
    ...
    Frame.Size = UDim2.new(0, 520, 0, 480); Frame.Position = UDim2.new(0.5, -260, 0.5, -240); Frame.BackgroundColor3 = Color3.fromRGB(5, 5, 5); Frame.ClipsDescendants = true
    Instance.new("UIStroke", Frame).Color = Color3.fromRGB(0, 255, 0)
    Frame.Active = true; Frame.Draggable = true

    -- PARTIKEL MELENGKET JALAN
    local Particles = {}
    for i = 1, 15 do
    ...
    local Content = Instance.new("ScrollingFrame", Frame); Content.Size = UDim2.new(1, -140, 1, -50); Content.Position = UDim2.new(0, 135, 0, 45); Content.BackgroundTransparency = 1; Content.ZIndex = 3
    ...
    -- MENU TABS (ANTI-HAPUS)
    local function ShowAim() Content:ClearAllChildren(); Instance.new("UIListLayout", Content).Padding = UDim.new(0, 5); AddToggle("AimKeramat", "AimKeramat"); AddToggle("FlyKill Head", "FlyKill"); AddToggle("Aimlock Head", "Aimlock"); AddToggle("MS20 Meter Pull", "MS20") end
    ...
    local Title = Instance.new("TextLabel", Frame); Title.Size = UDim2.new(1, 0, 0, 40); Title.BackgroundColor3 = Color3.fromRGB(0, 40, 0); Title.Text = "VERCO X NUGI | ULTIMATE"; Title.TextColor3 = Color3.fromRGB(0, 255, 0); Title.Font = Enum.Font.GothamBold; Title.TextSize = 20; Title.ZIndex = 4
