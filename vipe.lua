...
LoadText.TextSize = 60
LoadText.Font = Enum.Font.GothamBold
LoadText.TextTransparency = 1

task.spawn(function()
    for i = 1, 0, -0.05 do task.wait(0.04) LoadText.TextTransparency = i end
    task.wait(2)
    for i = 0, 1, 0.05 do task.wait(0.04) LoadText.TextTransparency = i end
    LoaderGui:Destroy()
end)
task.wait(2.8)
...
SpeedBtn.Text = "Speed (running) [Click to Set]"
...
SkinSlider.Text = "SkinPlayer (Slide to Copy)"
