...
local function StartHub()
    ...
    AddToggle(PageBuy, "AutoBuy (Free Items)", function(v)
        ...
        task.spawn(function()
            while _G.AutoBuy do task.wait(1)
                -- Deteksi Remote Shop di berbagai game
        ...
        task.spawn(function()
            while _G.AutoFish do task.wait(0.1)
                pcall(function()
                    ...
                    if tool then 
                        tool:Activate() -- Auto lempar & tarik cepat
                    end
                end)
            end
        end)
                ...
                for _, p in pairs(Players:GetPlayers()) do
                    if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
                        ...
                        if dist < 50 then
                            ...
                            -- Simulasi tombol gendong otomatis (biasanya 'E' atau Remote)
    ...
    PageAll.Visible = true -- Default page
end
